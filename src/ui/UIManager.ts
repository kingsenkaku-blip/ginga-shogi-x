...
export class UIManager {
  ...
  private renderTitleScreen(): string {
    ...
    return `
      <section class="title-screen title-splash">
        ...
        ${this.renderTitleBoardAnimation()}
  ...
  private renderTitleBoardAnimation(): string {
    ...
    return `
      <div class="title-board-anim" aria-hidden="true">
        <img src="${assetUrl("tower-conquest-bg.png")}" alt="" />
